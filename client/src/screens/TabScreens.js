...
const CustomComponent = ({ navigation }) => {
    return (
        <>
            <IconButton icon_name="user-friends" screen="Friends" navigation={navigation} />
            <IconButton icon_name="cog" screen="Setting" navigation={navigation} />
        </>
    );
};
...
const TabScreen = () => {
    ...
    const HomeStack = () => {
        return (
            <Stack.Navigator>
                <Stack.Screen name="Feed" component={Feed} options={customOption} />
                <Stack.Screen name="Restaurant" component={Restaurant} options={backOption} />
                <Stack.Screen name="Profile" component={Profile} options={backOption} />
            </Stack.Navigator>
        );
    };
    ...
    const ExploreStack = () => {
        return (
            <Stack.Navigator>
                <Stack.Screen name="Search" component={Search} options={customOption} />
                <Stack.Screen name="Restaurant" component={Restaurant} options={backOption} />
            </Stack.Navigator>
        );
    };
    ...
    const UserStack = () => {
        return (
            <Stack.Navigator>
                <Stack.Screen name="Profile" component={Profile} options={customOption} />
                <Stack.Screen name="Restaurant" component={Restaurant} options={backOption} />
            </Stack.Navigator>
        );
    };
